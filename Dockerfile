...
# Override handler.py with custom version that includes:
# - URL image download support (convert_url_to_base64)
# - Windows path normalization (normalize_workflow_paths)
